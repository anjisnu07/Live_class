...
<html lang="en">
  ...
  <strong>Info!</strong>You are already logged in.
</div>
	<!-- Main page it its -->
		...
		<div class="wrapper d-flex align-items-stretch">
			...
			<li>
	          ...
	          <li>
	              <a href="login.php"><i class="fa fa-sign-in"> Log in</a>
	          </li>
	         

	         
	          <li>
              <a href="register.php"><i class="fa fa-sign-up"></i> Sign up</a>
	          </li>
			...
			<ul class="list-group mt-5 text-white">
			  ...
			  <li class="list-group-item d-flex justify-content-between align-content-center">
				  ...
				  <div class="d-flex flex-row">
					  <img src="https://img.icons8.com/color/100/000000/folder-invoices.png" width="40" />
					  <div class="ml-2">
						  <h6 class="mb-0"><a href="sem4login.php">Sem-4</a></h6>
